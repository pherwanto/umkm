...
<div class="row g-3">
<div class="col-md-6"><label class="form-label">Nama</label><input class="form-control" name="nama" value="<?= e($row['nama_supplier'] ?? '') ?>" required></div>
<div class="col-md-6"><label class="form-label">Telepon</label><input class="form-control" name="telepon" value="<?= e($row['telepon'] ?? '') ?>"></div>
<div class="col-md-6"><label class="form-label">Jenis</label><input class="form-control" name="jenis" value="<?= e($row['jenis_supplier'] ?? '') ?>"></div>
...
</div><div class="mt-3"><button class="btn btn-primary">Simpan</button> <a class="btn btn-secondary" href="<?= e(url('index.php?page=supplier')) ?>">Kembali</a></div></form></div></div>
